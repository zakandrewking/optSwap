...
% setup Cleaner
    ...
    global run status
    status = 'starting';    
    run = 'best of 4--alanine result with new dhlist';
    
    interventionNum = 4;
    aer = {'anaerobic', 'anaerobic'}; %,'aerobic','anaerobic','aerobic'};
    substrates = {'EX_glc(e)','EX_xyl-D(e)'}; % ,'EX_glc(e)','EX_xyl-D(e)','EX_xyl-D(e)'};
    for i=1:2
