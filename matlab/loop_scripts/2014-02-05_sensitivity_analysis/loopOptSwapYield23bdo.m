function loopOptSwapYield23bdo
    ...
    logFile = 'optSwapYield-23bdo-anaerobic.tsv';
    ...
    thko = 'nothko';
    substrate = 'EX_glc(e)';
    targetRxns = {'EX_btd_meso(e)', 'EX_btd_RR(e)'};
    subsystems = {' 2,3-Butanediol production', ' 2,3-Butanediol production'};
